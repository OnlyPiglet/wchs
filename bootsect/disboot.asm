...
00007C06  E81800            call word 0x7c21
00007C09  E80200            call word 0x7c0e
00007C0C  EBFE              jmp short 0x7c0c
00007C0E  B8227C            mov ax,0x7c22
00007C11  89C5              mov bp,ax
00007C13  B91B00            mov cx,0x1b
00007C16  B80113            mov ax,0x1301
00007C19  BB0F00            mov bx,0xf
00007C1C  B200              mov dl,0x0
00007C1E  CD10              int 0x10
00007C20  C3                ret
00007C21  C3                ret
00007C22  41                inc cx
00007C23  20544F            and [si+0x4f],dl
00007C26  55                push bp
00007C27  52                push dx
00007C28  204F46            and [bx+0x46],cl
00007C2B  204F50            and [bx+0x50],cl
00007C2E  45                inc bp
00007C2F  52                push dx
00007C30  41                inc cx
00007C31  54                push sp
...
00007C33  4F                dec di
00007C34  4E                dec si
00007C35  205359            and [bp+di+0x59],dl
00007C38  53                push bx
00007C39  54                push sp
00007C3A  45                inc bp
00007C3B  4D                dec bp
00007C3C  2100              and [bx+si],ax
